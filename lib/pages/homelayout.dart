...
class _HomeLayoutState extends State<HomeLayout> {
  ...
  int SelectedIndex = 0;
  List<Widget> screens = [Orders(), Menus(), Transaction()];
          ...
          bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                    icon: Icon(Icons.sticky_note_2_outlined), label: 'الطلبات'),
                BottomNavigationBarItem(
                    icon: Icon(Icons.menu_book_outlined), label: 'القوائم'),
                BottomNavigationBarItem(
                    icon: Icon(Icons.credit_card_outlined), label: 'المعاملات'),
              ]),
